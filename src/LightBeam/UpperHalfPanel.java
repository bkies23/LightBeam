...
{   
    ...
    public void paint (Graphics g)
    {
        ...
        width = getWidth();
        height = getHeight(); 
        // image for UpperHalfPanel will be resized according to resized width and height dimensions
    ...
    public UpperHalfPanel ( )
    {
        ...
        gbc.weighty = 0.5;
        gbc.ipady= 30;
        gbc.insets = new Insets(10, 10, 10, 10); // set pixel spaces between text and frame sides
        gbc.fill = GridBagConstraints.HORIZONTAL;
        
        add(ta, gbc);
        
        iconLbl = new JLabel( ); 
        // imageIcon holds picture of country road with ten-foot pole emitting lightbeam and chalkboards at each side with tangent function information
        imageIcon = new ImageIcon(getClass().getResource("/Resources/RayOfLight.jpg"));
