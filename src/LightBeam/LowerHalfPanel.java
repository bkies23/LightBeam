...
{
    // LowerHalfPanel uses JLabels to display images along with current and previous angle distance.
    // It demonstrates the use of GridBagLayout.
    
    // User can use either PREVIOUS-NEXT buttons or ComboBox to select various angles
    ...
    JComboBox <String> cb;
    //Array of strings are image paths for ImageIcons
    String [] iconLblStrings = {"/Resources/ImageCover.png",
                                "/Resources/Infield.png",
                                "/Resources/FootballField.png",
                                "/Resources/Augusta.jpg",
                                "/Resources/Indy.jpg",
                                "/Resources/KansasCityToNewYork.png",
                                "/Resources/StLouisToPerth2.png",
                                "/Resources/HalfwayToMoon.png",
                                "/Resources/EarthToSun.png",
                                "/Resources/EarthToSaturn.jpg",
                                "/Resources/AlphaCentauri.jpg"};
    JPanel infoPanel;
    Font myFont = new Font ("Times New Roman", Font.PLAIN, 16);
    String comboBoxItem;
    GridBagConstraints gbc;
    DecimalFormat decimalFormat1 = new DecimalFormat("#,###.00");
    double [] distances; //will hold distances (length of opposite sides) for various angles
    BigDecimal bd; // must use BigDecimal to display final angle 89.999999999999999 with fifteen decimal places
    ImageIcon [] images;
    int numOfImages = 11;
    int imageIndex = 0; // imageIndex keeps track of correct image to show 
    ...
    public void CreateLowerHalfPanel ( int width, int height)
    {
        ...
        nextBtn.addActionListener(new ActionListener() 
        {
            public void actionPerformed(ActionEvent e) 
            {
                ...
                imageIndex += 1;
                // images 1 - 3 (baseball infield - Augusta 16th hole) are measured in feet
                // images 4 - 10 (all other images) are measured in miles
                if (imageIndex < 4)
                    feetOrMiles = " Feet";
                else
                    feetOrMiles = " Miles";
    ...
    private double AngleDistance (String angleStr )
    {
        ...
        if (angle > 89.0)
        {
            // Once angle exceeds 89.0 degrees, results need to be in miles.
    ...
    // Function computes the differenece in distances between current and previous angles.
